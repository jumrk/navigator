      ...
      <section className="listings" id="listings">
        <div className="property-card">
          ...
          <div className="property-info">
            <h3>Nhà phố Quận 7</h3>
            <p>Diện tích 80m² · Giá: 3.2 tỷ · Sổ hồng riêng</p>
          </div>
        </div>
        <div className="property-card">
          <img src="https://images.unsplash.com/photo-1599423300746-b62533397364" alt="Apartment" />
          <div className="property-info">
            <h3>Căn hộ cao cấp Thủ Đức</h3>
            <p>Diện tích 60m² · Giá: 2.1 tỷ · View đẹp</p>
          </div>
        </div>
        <div className="property-card">
          <img src="https://images.unsplash.com/photo-1572120360610-d971b9b788cc" alt="Villa" />
          <div className="property-info">
            <h3>Biệt thự nghỉ dưỡng Đà Lạt</h3>
            <p>Diện tích 150m² · Giá: 6.5 tỷ · Gần trung tâm</p>
          </div>
        </div>
      </section>
